...
for (int i = 0; i < timeout; i++) {
    if (WebUI.verifyElementText(findTestObject('Object Repository/Login/Register/Page_Advantage Shopping/label_User name already exists'), 
        'User name already exists', FailureHandling.OPTIONAL) == true) {
        WebUI.setText(findTestObject('Object Repository/Login/Register/Page_Advantage Shopping/input_usernameRegisterPage'), 
            'haha' + i)
